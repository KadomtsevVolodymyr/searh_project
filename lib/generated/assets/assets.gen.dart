...
class $AssetsImagesIconsGen {
  ...
  /// File path: assets/images/icons/favorite.png
  AssetGenImage get favorite =>
      const AssetGenImage('assets/images/icons/favorite.png');

  /// File path: assets/images/icons/favoriteIcon.svg
  SvgGenImage get favoriteIcon =>
      const SvgGenImage('assets/images/icons/favoriteIcon.svg');

  /// File path: assets/images/icons/logo.png
  AssetGenImage get logo => const AssetGenImage('assets/images/icons/logo.png');
  ...
  List<dynamic> get values =>
      [backIcon, close, favorite, favoriteIcon, logo, search];
}
